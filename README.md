...
My current work focus on detecting anomaly behaviors in microfabrication equipment. The anomaly detection system can help with yield improvement and preventive matainance. I am also a working with UN-ESCAP, Thailand to quantify the impact of agricultural burning and traffic on air pollution problems and health outcomes in ASEAN cities. The finding can help shape data-driven policy change.
